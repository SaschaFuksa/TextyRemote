...
public class HTMLMessagesFromUserInPeriod {
	...
	public static HTML generateMessagesFromUserInPeriodReport(Vector<Message> messages) {
		...
		report += "<table><tr><th>Author</th><th>Receiver</th><th>Message</th><th>Date of Creation</th></tr>";
		
		for(Message message : messages) {
			report += "<tr><td>" + message.getAuthor() + "</td><td>" + message.getListOfReceivers() + "</td><td>" + message.getText() + "</td>"
