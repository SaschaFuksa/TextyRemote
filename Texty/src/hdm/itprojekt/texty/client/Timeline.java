...
public class Timeline extends TextyForm {
	...
	protected void run() {
		...
		/*
		 * //Post 1 timeLabel.setText("13:15"); userLabel.setText("Autor");
		 * messageLabel.setText("Ich mag #Pizza");
		 * 
		 * messageLabel.addDoubleClickHandler(new DoubleClickHandler(){ public
		 * void onDoubleClick(DoubleClickEvent event) {
		 * messageLabel.setText("Edited"); } });
		 * 
		 * 
		 * Anchor anchor = new Anchor("Click me!"); // At this point clicking it
		 * won't do a thing anchor.addClickHandler(new ClickHandler() {
		 * 
		 * @Override public void onClick (ClickEvent event){
		 * Window.open("http://www.example.com/", "_blank", ""); // Or open a
		 * PopupPanel // or sth similar } });
		 * 
		 * Message m1 = new Message("#Hallo"); String s = m1.getText();
		 * 
		 * if ( s.startsWith("#")){ Window.alert("HU"); }
		 * 
		 * timeCarrier.add(timeLabel); userCarrier.add(userLabel);
		 * messageCarrier.add(messageLabel); container.add(timeCarrier);
		 * container.add(userCarrier); container.add(messageCarrier);
		 * 
		 * //Post 2 timeLabel2.setText("13:17"); userLabel2.setText("Autor");
		 * messageLabel2.setText("Ich mag doch keine #Pizza");
		 * timeCarrier2.add(timeLabel2); userCarrier2.add(userLabel2);
		 * messageCarrier2.add(messageLabel2); container2.add(timeCarrier2);
		 * container2.add(userCarrier2); container2.add(messageCarrier2);
		 * 
		 ...
		 * 
		 * detailsPanel.add(publicChatFlexTable); detailsPanel.add(anchor);
		 * 
		 * //int row = publicChatFlexTable.getRowCount();
		 ...
		 * //Message m1 = new Message("Hallo"); Message m2 = new
		 * Message("Hey, wie gehts dir?"); Message m3 = new
		 * Message("Habe Hunger, #Pizza verbrannt"); Message m4 = new
		 * Message("Oh nein :("); Message m5 = new Message("Naja wird schon");
