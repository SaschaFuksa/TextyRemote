...
public class PublicConversationViewer extends TextyForm {
	...
	private Label text = new Label("Here you can see all public messages from your subscribed user!");
...
//					RootPanel.get("Details").add(textLabel);
			...
			for (Hashtag hashtag : conversationView.getLastMessage().getListOfHashtag()){
