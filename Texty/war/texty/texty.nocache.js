...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "texty" because\n';
 ...
 * "/texty.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['texty'].superdevmode = true;

  var expectedSuffix = '/texty.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + texty + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:texty';
  var devModeSessionKey = '__gwtDevModeSession:texty';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/texty/texty.nocache.js';
  ...
  $wnd.__gwt_activeModules['texty'].canRedirect = true;
  $wnd.__gwt_activeModules['texty'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/texty?user.agent=' + ua + '&_callback=' + callback;
